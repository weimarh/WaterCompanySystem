...
{
    public sealed class CreateReadingCommandHandler : IRequestHandler<CreateReadingCommand, ErrorOr<Unit>>
    {
        ...
        public async Task<ErrorOr<Unit>> Handle(CreateReadingCommand command, CancellationToken cancellationToken)
        {
            ...
            await _publisher.Publish(new ReadingCreatedEvent(
                reading.ReadingId,
                reading,
                reading.ReadingDate,
                dueDate.Value,
